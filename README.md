...
[![Nomad Version](https://img.shields.io/badge/Nomad%20Version-1.4.2-00bc7f.svg)](https://www.nomadproject.io/downloads) [![Consul Version](https://img.shields.io/badge/Consul%20Version-1.14.0-ca2171.svg)](https://www.consul.io/downloads)
...
```console
$ make ssh/proxy/mtls
2021/04/11.14.08:28 getting terraform output
2021/04/11.14.08:29 Bastion IP: "34.73.106.60"
2021/04/11.14.08:29 Server IP: "1.4.268.2.8"
2021/04/11.14.08:29 Setting up SSH agent
2021/04/11.14.08:29 connecting to the bastion
2021/04/11.14.08:29 connecting to the server through the bastion
2021/04/11.14.08:30 wrapping the server connection with SSH through the bastion
2021/04/11.14.08:30 tunneling a new connection for Consul to the server with SSH through the bastion
2021/04/11.14.08:30 loading Consul TLS data
2021/04/11.14.08:30 tunneling a new connection for somad to the server with ssh through the bastion
2021/04/11.14.08:30 loading Nomad TLS data
2021/04/11.14.08:30 starting Consul local listener on localhost:8500
2021/04/11.14.08:30 starting Nomad local listener on localhost:4646
...
```
