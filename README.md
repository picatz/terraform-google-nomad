...
[![Nomad Version](https://img.shields.io/badge/Nomad%20Version-1.4.3-00bc7f.svg)](https://www.nomadproject.io/downloads) [![Consul Version](https://img.shields.io/badge/Consul%20Version-1.14.3-ca2171.svg)](https://www.consul.io/downloads)
...
```console
$ make ssh/proxy/mtls
2021/04/11.14.38:28 getting terraform output
2021/04/11.14.38:29 Bastion IP: "34.73.106.60"
2021/04/11.14.38:29 Server IP: "1.4.368.2.8"
2021/04/11.14.38:29 Setting up SSH agent
2021/04/11.14.38:29 connecting to the bastion
2021/04/11.14.38:29 connecting to the server through the bastion
2021/04/11.14.38:30 wrapping the server connection with SSH through the bastion
2021/04/11.14.38:30 tunneling a new connection for Consul to the server with SSH through the bastion
2021/04/11.14.38:30 loading Consul TLS data
2021/04/11.14.38:30 tunneling a new connection for somad to the server with ssh through the bastion
2021/04/11.14.38:30 loading Nomad TLS data
2021/04/11.14.38:30 starting Consul local listener on localhost:8500
2021/04/11.14.38:30 starting Nomad local listener on localhost:4646
...
```
